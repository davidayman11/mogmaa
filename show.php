...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        if ($is_logged_in) {
            ...
            echo "<a href='edit.php?id=" . htmlspecialchars($row["id"]) . "' class='edit'>Edit</a> | ";
            echo "<a href='delete.php?id=" . htmlspecialchars($row["id"]) . "' class='delete'>Delete</a> | ";
            echo "<a href='resend.php?id=" . htmlspecialchars($row["id"]) . "' class='resend'>Resend</a>";
            echo "</td>";
        }
        echo "</tr>";
