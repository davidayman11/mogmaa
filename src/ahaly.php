...
<head>
    ...
    <title>MOGAM3'24 - Ahaly Registration</title>
    <link rel="stylesheet" href="../css/main.css">
    <link rel="stylesheet" href="../css/styles.css">
    <meta name="description" content="MOGAM3'24 Ahaly Team Registration">
    <meta name="keywords" content="MOGAM3, ahaly, registration, team">
</head>
<body>
    <div class="demo-page">
            ...
            <section>
                ...
                <form action="submit.php" method="post" class="registration-form">
                    ...
                    <div class="nice-form-group">
                        ...
                        <input type="text" id="team" name="team" placeholder="Ahaly" value="ahaly" readonly required/>
                    </div>
